...
import { ItemType } from "../data/localData";
...
export const TabbedSectionItem: React.FC<ItemType> = React.memo(
  ({ imageUrl, name, desc }: any) => {
    return (
      <SafeAreaView edges={["left", "right"]} style={styles.container}>
        <View style={styles.itemContainer}>
          <View style={styles.itemTitleContainer}>
            <Text style={[screenStyles.text, styles.itemTitle]}>{name}</Text>
            <Text style={[screenStyles.text, styles.itemSubtitle]}>{desc}</Text>
          </View>
